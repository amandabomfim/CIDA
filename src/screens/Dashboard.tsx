    ...
    const navigationView = () => (
        <LinearGradient
            ...
            <View style={styles.userContainer}>
                ...
                <Text style={[styles.paragraph, { color: 'white', marginLeft: 10 }]}>
                    {userData.nome}
                </Text>
            </View>
            <View style={styles.menuContainer}>
                ...
                <TouchableOpacity
                    onPress={() => {
                        navigation.replace('Upload', { userData })
    ...
    return (
        <>
            <DrawerLayoutAndroid
                ref={drawer}
                drawerWidth={300}
                statusBarBackgroundColor={'#330DE9'}
                ...
                <ScrollView style={styles.container}>
                    ...
                    <View style={styles.insightsContainer}>
                        ...
                        <Text style={styles.insightItem}>
                            ✓ A adoção do produto teve um aumento significativo de 55% em comparação
                            ao período anterior. Isso sugere uma maior aceitação e interesse dos
                            usuários no produto.
                        </Text>
                        <Text style={styles.insightItem}>
                            ✓ Houve uma queda de 12% na taxa de retenção dos usuários em relação ao
                            período anterior. Isso pode indicar problemas de satisfação do cliente
                            ou necessidade de melhorias na experiência do usuário.
                        </Text>
                        <Text style={styles.insightItem}>
                            ✓ O engajamento dos usuários aumentou em 15%, o que é um sinal positivo
                            de que estão interagindo mais com o produto. Isso pode resultar em maior
                            fidelização e satisfação do cliente.
                        </Text>
                        <Text style={styles.insightItem}>
                            ✓ A taxa de sucesso teve um aumento significativo de 55%, o que indica
                            que os usuários estão alcançando seus objetivos ao usar o produto. Isso
                            pode ser atribuído a melhorias na usabilidade ou funcionalidades
                            adicionais.
                        </Text>
                        <Text style={styles.insightItem}>
                            ✓ A felicidade do cliente está em um nível saudável de 72,0. Isso sugere
                            que os usuários estão satisfeitos com a experiência geral do produto,
                            mas ainda há espaço para melhorias para alcançar uma pontuação ainda
                            mais alta.
                        </Text>
                    </View>
                </ScrollView>
